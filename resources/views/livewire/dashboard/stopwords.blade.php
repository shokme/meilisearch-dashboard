<div x-data="{ focus: false, words: [] }">
    ...
    <p>List of words that should be considered as optional. <a class="underline text-blue-500" target="_blank" href="https://docs.meilisearch.com/guides/advanced_guides/settings.html#stop-words">Learn more</a></p>
